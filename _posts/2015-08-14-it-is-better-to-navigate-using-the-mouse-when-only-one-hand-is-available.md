...
I.e., most of the time. People who code for their day job may well spend more time stooped over the keyboard with both hands. However, someone who only casually codes, such as myself, will spend only a couple of hours typing intensely, and spend more time browsing the web, researching, and copy and pasting the odd bit of text. Sadly, there is a trend of "simple, usable, lightweight" aka meme WMs to make it very hard to operate with one hand, because they operate under the assumption that everyone is a code monkey who has two hands on the keyboard most of the time. There is one simple ommission that makes it hard to operate with one hand: not allowing click-to-raise policy. Sloppy focus or click-to-focus is proably greate for someone who spends all day writing code. The casual user, however, really needs click-to-raise, or their web browsing experience is completely fucked, as they now have to pinky stretch to a modifier key just to e.g., switch to a terminal when pasting code. Even if the stacker supports clickable titlebars and borders, they still only offer small and awkward to hit targets, whereas click-to-raise offers huge targets of whole windows.
...
I'd make similar arguments for tiling window managers; most of them don't do enough to at least offer some basic mouse support for some edge cases where mouse usage is optimal, but that would take a whole other post entirely to justify myself. 

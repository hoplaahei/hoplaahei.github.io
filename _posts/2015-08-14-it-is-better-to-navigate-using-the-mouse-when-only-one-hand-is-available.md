...
A great deal of casual computing tasks are comfortably done with only one hand on the keyboard or pointing device. For instance, I can happily go for an hour opening links with the trackpoint on content aggrgator sites. If I'm on the couch, this means I can slouch out and rest on one elbow, or have a cup of coffee in the other hand. The idea that people should use their computers with two hands over the keyboard at all times, without exception, is an asinane one, but this idea seems implicit in todays "mouse is evil" Linux culture.
